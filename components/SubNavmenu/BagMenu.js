    ...
    <Container className='mt-2 py-5'>
      <Row className='justify-content-evenly'>
        <Col lg={3}>
          <div>
            <Image
              src='https://res.cloudinary.com/ceenobi/image/upload/v1639042219/Fashion/443497_DTDIT_1000_005_100_0000_Light-GG-Marmont-small-matelass-shoulder-bag_bkrkxr.webp'
              width={250}
              height={300}
              alt='cloth'
            />
